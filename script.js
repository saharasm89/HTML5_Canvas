...
imgMouse.src = 'assets/mouse.png';

var imgCheese = new Image();
imgCheese.src = 'assets/cheese.png';

var soundWalk = new Audio("assets/SnowWalk.ogg");
...
modelfunwin = function() {
    ...
    modal.style.display = "block";
    x = document.querySelector(".gamehead");
    x.textContent = "Congrats! You got the cheese!"
...
var maze = function (X, Y) {
    ...
    this.draw_canvas = function (id) {
        ...
        if (this.canvas.getContext) {
            ...
            // Initial drawing for Main Character
            this.ctx.fillStyle = "#5876E2";
            this.ctx.fillRect(scale* x[0], scale * x[1], scale, scale);

            
            this.ctx.drawImage(imgMouse, scale* x[0], scale * x[1], scale, scale);
            this.ctx.drawImage(imgCheese, scale * 19, scale * 20, scale, scale); 
            this.Board[x[0]][x[1]] = '&';

            console.log("Finished drawing mouse");
        }
...
//Main Character
    this.move =  function (a,b) {
        var scale = this.S;
        this.ctx = this.canvas.getContext('2d');
        this.ctx.drawImage(imgMouse, scale * a, scale * b, scale, scale);
        this.ctx.drawImage(imgCheese, scale * 19, scale * 20, scale, scale); 
        this.Board[a][b] = '&';
        soundWalk.play();
    }
